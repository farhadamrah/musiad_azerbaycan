            ...
            <div class="row">
              ...
              >
                <div class="widget about-widget mb-45">
                  ...
                  <ul class="widget-link">
                    ...
                    <li>
                      <a href="https://www.musiad.org.tr/" target="_blank"
                        >Baş ofis</a
                      >
                    </li>
                  </ul>
              ...
              <div class="col-lg-2 col-md-6 col-sm-12">
                <div class="widget widget-categories mb-45">
                  ...
                  <ul class="widget-link">
                    <li>
                      <a href="http://millimeclis.az" target="_blank"
                        >www.millimeclis.az</a
                      >
                    </li>
                    <li>
              ...
              <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="widget contact-widget mb-45">
                  ...
                  <div class="contact-info">
                    ...
                    <p>
                      <i class="fa fa-envelope"></i
                      ><a href="mailto:yourmail.@gmail.com">info@musiad.az</a>
                    </p>
                    <p>
                      <i class="fa fa-phone"></i
                      ><a href="tel:0123456789101"> +994 12 440 06 90</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="widget contact-widget mb-45">
                  ...
                  <div
                    class="nav-button d-flex justify-content-center mt-15 mr-0"
                  >
                    <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="copyright-text text-center">
                <p>
                  Copyright 2021 by
                  <a href="https://butagrup.com.tr/?lang=az" target="_blank"
                    >ButaGrup</a
                  >
                </p>
              </div>
